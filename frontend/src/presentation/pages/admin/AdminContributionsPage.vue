...
/**
 * La prose traduite par l'assistant. `project`, `reference`, `url` et
 * `position` sont recopiés tels quels : un nom de projet, une référence de
 * PR ou une URL n'ont pas de traduction (spec 0002, D2). Le corps garde ses
 * `backticks`, le prompt l'exige et RichText les rend.
 */
 ...
 * reste conservé, rien d'enregistré ici (ADR 0004, D4). En échec, le
 * formulaire reste intact et la raison s'affiche.
 */
