...
final class BackofficeIncidentOrderResourceTest extends WebTestCase
{
    ...
    public function testReorderingIsReflectedOnTheBackofficeCollectionAndBothPublicEndpoints(): void
    {
        ...
        $positionsByGroup = array_combine(
            array_column($collection, 'translationGroup'),
            array_column($collection, 'position'),
        );
        self::assertSame(0, $positionsByGroup[$second]);
        self::assertSame(1, $positionsByGroup[$first]);
