...
final class BackofficeStatResourceTest extends WebTestCase
{
    ...
    public function testFullCrudCycleAsRoleSuper(): void
    {
        ...
        ], content: self::jsonBody(['locale' => 'fr', 'value' => '+50K', 'label' => 'Lignes de code', 'iconKey' => 'code', 'position' => 0]));
        self::assertResponseIsSuccessful();
        ...
        $client->request('PUT', sprintf('/api/backoffice/stats/%d', $id), server: [
            'CONTENT_TYPE' => 'application/json',
            'HTTP_X_XSRF_TOKEN' => $csrfToken,
        ], content: self::jsonBody(['locale' => 'fr', 'value' => '+60K', 'label' => 'Lignes de code (maj)', 'iconKey' => 'box', 'position' => 1]));
        self::assertResponseIsSuccessful();
        ...
        $client->request('PUT', '/api/backoffice/stats/999999', server: [
            'CONTENT_TYPE' => 'application/json',
            'HTTP_X_XSRF_TOKEN' => $csrfToken,
        ], content: self::jsonBody(['value' => 'x', 'label' => 'x', 'iconKey' => 'x', 'position' => 0]));
