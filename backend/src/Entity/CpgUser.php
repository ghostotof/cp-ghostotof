 ...
 * (App\Command\CreateCpgUserCommand) : il n'existe volontairement aucun
 * formulaire d'inscription. Identifiant de connexion : un simple nom
 * d'utilisateur (pas d'email stocké, aucune donnée personnelle identifiante).
 */
