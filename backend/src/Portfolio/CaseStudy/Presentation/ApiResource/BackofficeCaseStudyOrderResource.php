...
use App\Portfolio\CaseStudy\Infrastructure\ApiPlatform\BackofficeCaseStudyOrderProcessor;
use App\Portfolio\Shared\Presentation\ApiResource\CarriesOrderedKeys;
use Symfony\Component\Validator\Constraints as Assert;

/**
 * PUT /api/backoffice/case-studies/order — l'unique écrivain de la position
 * des études de cas (spec 0004 D3), réservé ROLE_SUPER par la règle
 ...
 */
#[ApiResource(
    shortName: 'BackofficeCaseStudyOrder',
    operations: [
        new Put(
            uriTemplate: '/backoffice/case-studies/order',
            status: 204,
            read: false,
            output: false,
            processor: BackofficeCaseStudyOrderProcessor::class,
        ),
    ],
)]
final readonly class BackofficeCaseStudyOrderResource
{
