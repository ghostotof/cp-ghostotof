...
use App\Portfolio\Contribution\Infrastructure\ApiPlatform\BackofficeContributionOrderProcessor;
use App\Portfolio\Shared\Presentation\ApiResource\CarriesOrderedKeys;
use Symfony\Component\Validator\Constraints as Assert;

/**
 * PUT /api/backoffice/contributions/order — l'unique écrivain de la position
 * des contributions (spec 0004 D3), réservé ROLE_SUPER par la règle
 ...
 */
#[ApiResource(
    shortName: 'BackofficeContributionOrder',
    operations: [
        new Put(
            uriTemplate: '/backoffice/contributions/order',
            status: 204,
            read: false,
            output: false,
            processor: BackofficeContributionOrderProcessor::class,
        ),
    ],
)]
final readonly class BackofficeContributionOrderResource
{
