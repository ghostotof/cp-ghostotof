...
use App\Portfolio\Quality\Infrastructure\ApiPlatform\BackofficeQualityTraitOrderProcessor;
use App\Portfolio\Shared\Presentation\ApiResource\CarriesOrderedKeys;
use Symfony\Component\Validator\Constraints as Assert;

/**
 * PUT /api/backoffice/quality/traits/order — l'unique écrivain de la position
 * des traits qualité (spec 0004 D3), réservé ROLE_SUPER par la règle
 ...
 */
#[ApiResource(
    shortName: 'BackofficeQualityTraitOrder',
    operations: [
        new Put(
            uriTemplate: '/backoffice/quality/traits/order',
            status: 204,
            read: false,
            output: false,
            processor: BackofficeQualityTraitOrderProcessor::class,
        ),
    ],
)]
final readonly class BackofficeQualityTraitOrderResource
{
