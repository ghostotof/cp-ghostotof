...
use App\Portfolio\Quality\Infrastructure\ApiPlatform\BackofficeQualityPrincipleOrderProcessor;
use App\Portfolio\Shared\Presentation\ApiResource\CarriesOrderedKeys;
use Symfony\Component\Validator\Constraints as Assert;

/**
 * PUT /api/backoffice/quality/principles/order — l'unique écrivain de la position
 * des principes qualité (spec 0004 D3), réservé ROLE_SUPER par la règle
 ...
 */
#[ApiResource(
    shortName: 'BackofficeQualityPrincipleOrder',
    operations: [
        new Put(
            uriTemplate: '/backoffice/quality/principles/order',
            status: 204,
            read: false,
            output: false,
            processor: BackofficeQualityPrincipleOrderProcessor::class,
        ),
    ],
)]
final readonly class BackofficeQualityPrincipleOrderResource
{
