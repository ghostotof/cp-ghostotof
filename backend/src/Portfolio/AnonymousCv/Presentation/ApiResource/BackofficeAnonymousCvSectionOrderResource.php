...
use App\Portfolio\AnonymousCv\Infrastructure\ApiPlatform\BackofficeAnonymousCvSectionOrderProcessor;
use App\Portfolio\Shared\Presentation\ApiResource\CarriesOrderedKeys;
use Symfony\Component\Validator\Constraints as Assert;

/**
 * PUT /api/backoffice/anonymous-cv/order — l'unique écrivain de la position
 * des sections du CV sans identité (spec 0004 D3), réservé ROLE_SUPER par la règle
 ...
 */
#[ApiResource(
    shortName: 'BackofficeAnonymousCvSectionOrder',
    operations: [
        new Put(
            uriTemplate: '/backoffice/anonymous-cv/order',
            status: 204,
            read: false,
            output: false,
            processor: BackofficeAnonymousCvSectionOrderProcessor::class,
        ),
    ],
)]
final readonly class BackofficeAnonymousCvSectionOrderResource
{
